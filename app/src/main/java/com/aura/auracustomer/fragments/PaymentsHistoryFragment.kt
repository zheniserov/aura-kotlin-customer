...
import kotlinx.android.synthetic.main.fragment_payments_history.*
 ...
 * Use the [PaymentsHistoryFragment.newInstance] factory method to
...
//        payments_history_recycler_view.adapter = paymentsHistoryAdapter
    ...
    companion object {
         ...
         * @return A new instance of fragment PaymentsHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PaymentsHistoryFragment().apply {
